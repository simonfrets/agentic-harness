...
import { diagnoseHarness } from "../../install/diagnose-harness.js";
...
/**
 * Reports whether the installed harness can run.
 *
...
export const doctor: CliCommandHandler = async (context) => {
  ...
  const diagnosis = await diagnoseHarness({
    projectRoot,
    runner: context.runner,
    nodeVersion: context.nodeVersion,
    harnessVersion: readPackageVersion(context.packageRootDirectory),
  });
